...
class DataLoader:
    ...
    def __iter__(self) -> List[Dict[str, Tensor]]:
        ...
        """
        def combine_batch_dicts(batch:List[Dict[str, DatasetSimulationData]]) -> Dict[str, List[DatasetSimulationData]]:
            """
        ...
        def batch_to_tensor(batch:Dict[str, List[DatasetSimulationData]]) -> Dict[str, Tensor]:
            """
