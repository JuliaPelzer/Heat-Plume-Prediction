...
class TurbNetG(nn.Module):
    def __init__(self,in_channels = 2, channelExponent=6, dropout=0.):
        ...
        self.layer3 = blockUNet(channels*4, channels*8, 'layer3', transposed=False, bn=True,  relu=False, dropout=dropout )
        ...
        self.dlayer3 = blockUNet(channels*8, channels*4, 'dlayer3', transposed=True, bn=True, relu=True, dropout=dropout )
