...
class SettingsTraining:
    def __init__(self,
        ...
        if self.destination == "": 
            self.destination = f"case_{self.case} prev_{self.prev_boxes} extend_{self.extend} skip_{self.skip_per_dir} j_conv{self.overfit_str} {self.loss} {self.num_layers}layers"
