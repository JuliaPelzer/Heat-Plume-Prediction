...
if __name__=="__main__":
    ...
    # allin1 
    data_prep = Path("/scratch/sgs/pelzerja/datasets_prepared/allin1/dataset_giant_100hp_varyK inputs_ixydk+s_outer outputs_t") #/scratch/sgs/pelzerja/datasets_prepared/allin1/giant_double inputs_ixydk outputs_t prep_with_BEST_predict_v_v4") #/scratch/sgs/pelzerja/datasets_prepared/allin1/dataset_giant_100hp_varyK inputs_pki outputs_t")
    ...
    model_path = Path("/home/pelzerja/pelzerja/test_nn/1HP_NN/runs/allin1/predict_T_additional_s_outer_input MAE") #/home/pelzerja/pelzerja/test_nn/1HP_NN/runs/allin1/predict_T_from_s hyperparam_opt/MAE_real_trial11 BEST_MAE") #/home/pelzerja/pelzerja/test_nn/1HP_NN/runs/allin1/naive_approach_unetnopad")
    model_name = "model.pt"
    # 1hp-cnn, 2hp-cnn    model = UNet(in_channels=4) # or 2
    # naive allin1     model = UNetNoPad2(in_channels=3)
    # allin1 T / v
    model = UNetNoPad2(in_channels=6, out_channels=1, kernel_size=4, depth=4, init_features=32)
