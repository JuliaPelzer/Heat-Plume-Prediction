...
#EOSWaterSaturationPressureIFC67
def eos_water_saturation_pressure_IFC67(T:float) -> float:
    """
    Computes the saturation pressure of water at a given temperature using the IFC67 equation of state.
...
#EOSWaterViscosity1
def eos_water_viscosity_1(T: float, P: float, PS: float):
    EX  = 247.8 / (T+133.15)
    PHI = 1.0467 * (T-31.85)
